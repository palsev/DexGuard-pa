import { DEFAULT_DEADLINE_FROM_NOW, DEFAULT_GAS_ESTIMATE, DEFAULT_GAS_PRICE, DEFAULT_ETH_TIP } from '../../constants'
...
import {
  ...
  updateUserGasPrice,
  updateUserGasEstimateManualOverride,
...
export interface UserState {
  ...
  userUnderlyingExchange: string // underlying UniswapV2Router02 to use
  userGasPrice: string // Current gas price
  userETHTip: string // Current gas price
  userGasEstimate: string // Gas estimate for trade
  userGasEstimateManualOverride: boolean // Gas estimate for trade update
  userTipManualOverride: boolean
}
...
export const initialState: UserState = {
  ...
  userGasEstimateManualOverride: false,
  userTipManualOverride: true,
}
...
export default createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(updateUserGasEstimateManualOverride, (state, action) => {
      state.userGasEstimateManualOverride = action.payload.userGasEstimateManualOverride
    })
