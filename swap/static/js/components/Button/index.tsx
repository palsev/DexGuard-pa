...
export const ButtonPrimary = styled(Base)`
  ...
  background: linear-gradient(-45deg, #BC29BB 0%, #315ECF 100%) !important;
  color: white;
  border: 0;
  border-radius: 10px;
  &:focus {
  ...
  &:disabled {
    background: ${({ theme, altDisabledStyle, disabled }) =>
      altDisabledStyle ? (disabled ? '#AAAAAA !important' : '#AAAAAA !important') : '#AAAAAA !important'};
    border: 0;
    color: white;
    cursor: auto;
    box-shadow: none;
...
export const ButtonLight = styled(Base)`
  ...
  background: linear-gradient(-270deg, #315ECF 0%, #BC29BB 100%);
  border-radius: 10px;
  color: #fff;
  border: 0;
  font-size: 16px;
