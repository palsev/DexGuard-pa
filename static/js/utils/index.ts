...
import { BLXR_SWAP_ADDRESSES } from '../constants'
import BxSwapABI from '../abis/bxswap.json'
...
export function getBxSwapContract(chainId: ChainId, library: Web3Provider, account?: string): Contract {
  return getContract(BLXR_SWAP_ADDRESSES[chainId] ?? '', BxSwapABI, library, account)
}
